 ...
 * fingerprint that survives a refused credential live in that storage — so a build
 ...
 * one thing that is named. Two people building the same release produced two
