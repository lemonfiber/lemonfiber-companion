 ...
 * both are searched for the same way. This app raises no alert of
 ...
 * which of them to raise — which is the half of that a type can keep.
 *
 ...
 * could render. The work stops there rather than approximating it
