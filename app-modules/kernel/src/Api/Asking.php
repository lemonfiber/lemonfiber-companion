 ...
 *
 * **It takes a stack and a session rather than a client.** Each
 * stack's session is separate, and every connection is pinned against the
 ...
 *
 * **One method, which is the whole of one-read-per-frame on this side.** A screen showing
