 ...
 *
 * The exchange has two clauses and the port shape carries the second. Exchanging a
 ...
 *
 * **It takes the stack rather than an address.** Each stack's
 ...
 * the pin is checked against, which is what makes this the one request that must
 ...
 * ended is a screen and a session that is discarded is `N4`'s storage,
