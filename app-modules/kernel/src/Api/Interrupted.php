 ...
 *
 * **Report it where the operator is, offer a new session there, and
 ...
 *
 * **An ended session is not a refused credential.** The two arms
 ...
 * and a remedy, which is asked of every refusal — and an ended
 ...
 * interruption that can discard what pairing established. Trust is pinned
...
final readonly class Interrupted
{
     ...
     *
     * Takes the obstacle because this one has something to say: what is wanted is
     ...
     *
     * On both arms, because each stack's session is separate and an
