 ...
 *
 * `N4-R4` is the requirement and it is the one that needs a record: a declined
 ...
 * the behaviour `N4-R4` exists to forbid.
 */
enum Asked: string
{
     ...
     *
     * The whole of `N4-R4` in one place. `Granted` answers false for a
     ...
     * it — `N4-R2` wants the app's own words first.
     */
