 ...
 *
 * `N1-R11` holds more than one configured stack and `N1-R35` turns *none of
 ...
 * either.** That one keeps a session, which `N1-R23` and `N4-R5` say the app
 ...
 * the app *must* retain, and what `N1-R34` refuses to let a discard of retained
...
interface Stacks
{
     ...
     * N1-R11 guarantees with the value instead of with each caller: there is no
     ...
     * is the conservative direction: `N1-R35`'s screen is the right place to
     ...
     * does with one, and `N1-R22` is why — a machine that comes back on another
