 ...
 * `ARCH-R79` requires a capability the stack does not have to be **absent**
 ...
 *
 * The distinction is not pedantry: `N1-R30` says each must be reported as
...
enum Availability: string
{
     ...
     * — `N1-R3` refuses hiding — but neither is a button that would work.
     */
