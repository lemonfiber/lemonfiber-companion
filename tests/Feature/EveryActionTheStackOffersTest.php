 ...
 */
const OFFERED = [
    'Alerts', 'Archives', 'Bandwidth', 'Clients', 'Config', 'Credentials', 'Dashboard', 'Doctor', 'Error', 'Forms', 'FrontDoor',
 ...
 */
const NOT_YET = [
    'Admission', 'Adoption', 'Backup', 'Beside', 'Bundle', 'Catalogue', 'Import', 'Lifecycle', 'Migration', 'Music', 'Plugins', 'Pull', 'Quality', 'Removal', 'Replacement', 'Reset', 'Restore',
