...
/**
 * A stack where a test says what is already on its machine, and which remembers being asked.
 *
 * {@see AStackWithAFrontDoor}'s sibling one endpoint along.
 *
...
final class AStackWithSomethingAlreadyOnIt implements MovingIn
{
    ...
    {
        return new self(static fn(): WhatWasFoundAlreadyHere => WhatWasFoundAlreadyHere::met($why));
    }
