...
| `N2-R18` | How an update taken went, read off the update's own report and kept apart from what is on offer now | `Upkeepers::whatBecameOf()`, which follows the handle taking it answered, and `Endings` |
