...
return [
    ...
    'walkthrough' => [
        ...
        'no_road' => 'De walkthrough noemt geen stappen.',
        'walk_label' => 'Wat ophalen',
        'walk_placeholder' => 'Een titel',
        'blank_picks' => 'Laat het leeg en de stack kiest iets dat waarschijnlijk lukt.',
        'walk' => 'Beginnen',
        ...
        'already_here_unnamed' => 'Waar om gevraagd werd, was er al, dus er is niets opnieuw opgehaald.',
        'walked' => '“:item” doorgelopen',
        'proves' => 'Wat het wilde laten zien: :proves',
        'stopped_at' => 'Het stopte bij :step',
        'try' => 'Probeer dit: :remedy',
        'logs' => 'Wat de diensten zeiden',
        'no_logs' => 'De diensten zeiden op dat moment niets.',
        'record' => 'Wat het zei, op volgorde',
        'said_nothing' => 'Het zei niets.',
        'in_background' => 'De download gaat op de achtergrond door in plaats van dat erop gewacht wordt.',
        'what_next' => 'Wat nu',
        'where_to_watch' => 'Met welke app kijken',
        'nothing_next' => 'Het noemde niets om hierna te doen.',
        'suggested' => 'Iets dat waarschijnlijk lukt',
        'walk_this' => 'Kijk hoe “:item” binnenkomt',
        'nothing_suggested' => 'Het stelde niets voor.',
        'state' => [
            'offered' => 'Aangeboden aan het eind van de installatie, en nog niet beantwoord.',
            'skipped' => 'Afgeslagen. Het kan op elk moment alsnog.',
            'searching' => 'Zoekt naar releases.',
            'grabbing' => 'Stuurt een release naar de downloadclient.',
            'downloading' => 'Downloadt.',
            'importing' => 'Zet de voltooide download in de bibliotheek.',
            'complete' => 'Het staat in de bibliotheek en kan worden afgespeeld.',
            'failed' => 'Het stopte bij een genoemde stap.',
            'abandoned' => 'Halverwege verlaten. Wat onderweg was, gaat door.',
        ],
        'shape' => [
            'pipeline' => 'De hele weg: zoeken, grabben, downloaden, importeren en het in de bibliotheek zien.',
            'library-only' => 'Voor een stack die niets ophaalt: media die al op schijf staan, nagekeken of de mediaserver ze ziet.',
        ],
        'link' => [
            'hardlinked' => 'De bibliotheek en de download delen één bestand, dus het kost geen extra ruimte.',
            'copied' => 'Het bestand is gekopieerd, dus het neemt zijn ruimte nu twee keer in, en elke import doet dat opnieuw.',
        ],
        'next' => [
            'more-content' => 'Voeg meer toe, nu je gezien hebt hoe het werkt.',
            'household' => 'Laat de rest van het huishouden zelf om dingen vragen.',
            'client-apps' => 'Kijk het ergens anders dan op de machine waar het draait.',
        ],
        'stopped' => [
            'no-indexers' => 'Er is geen indexer ingesteld, dus er valt niets te doorzoeken.',
            'indexers-failed' => 'De indexers, of de dienst die ze beheert, antwoordden niet, dus de zoektocht is nooit gedaan.',
            'nothing-matched' => 'De zoektocht is gedaan en vond niets. De indexers werken.',
            'none-met-the-preset' => 'Er zijn releases, en geen enkele voldoet aan de kwaliteitsinstelling. De stack werkt; de instelling en wat er te vinden is, zijn het oneens.',
            'tunnel-down' => 'Er doen torrents mee en de tunnel is niet bevestigd, dus er is niets gegrabd.',
            'not-grabbed' => 'De release is nooit aan een downloadclient gegeven.',
            'stalled' => 'De download kwam niet meer verder.',
            'import-failed' => 'De download was klaar en de bibliotheekbeheerder wilde hem niet hebben.',
            'no-media-server' => 'Er draait geen mediaserver in deze form, dus niets kan het afspeelbaar maken.',
            'not-visible' => 'Het is geïmporteerd en de mediaserver is ingelicht, en de mediaserver kan het nog steeds niet vinden.',
        ],
    ],
    'at_stage' => 'Fase: :stage',
    'stage' => [
