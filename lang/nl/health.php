...
return [
    ...
    'mended' => [
        ...
        'declined' => 'Niet gedaan: er is niet mee ingestemd',
        'would_overwrite' => 'Niet gedaan: het zou iets overschrijven',
        'unmanaged' => 'Niet gedaan: je hebt dit als onbeheerd opgegeven',
    ],
    ...
    'stuck_count_where_it_looked' => '{0} Van wat hij kon bekijken is niets blijven steken|{1} Van wat hij kon bekijken is één ding blijven steken|[2,*] Van wat hij kon bekijken zijn :count dingen blijven steken',
    'could_not_reach' => 'Waar de stack niet bij kon',
    'could_not_reach_explained' => 'De stack kon hier niet in kijken, dus wat daarachter vastzit ontbreekt in deze lijst.',
    'stuck_in' => 'In :service',
