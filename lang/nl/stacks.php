...
return [
    ...
    'already_here' => [
        ...
        'running' => 'Draait',
        'stopped' => 'Aanwezig, en gestopt',
        'adoptable' => 'lemonfiber kan het overnemen zoals het is',
        'not_adoptable' => 'lemonfiber kan het niet overnemen zoals het is',
        'ports' => 'Publiceert :ports',
        'no_ports' => 'Publiceert geen poort',
        'no_services' => 'Het heeft geen services',
        'conflicts' => 'Poorten die al bezet zijn',
        'no_conflicts' => 'Geen poort die lemonfiber wil is bezet',
        'conflict' => 'Poort :port is bezet door :held_by, en :wanted_by van lemonfiber wil hem',
        'beside' => 'Waar elke service bereikt zou worden, naast wat hier staat',
        'moved' => ':service zou op poort :to komen in plaats van :from',
        'none_moved' => 'Geen service zou naar een andere poort gaan',
        'cannot_take' => 'Wat niet overgenomen kan worden',
        'unsupported' => ':what: :because',
        'nothing_unsupported' => 'Niets van wat er staat is buiten het bereik van lemonfiber',
        'cannot_link' => 'Deze indeling kan geen hardlink bevatten',
        'filesystems' => 'De bestandssystemen waar het om gaat: :filesystems',
        'remedy_is_yours' => 'Niets hier doet dit voor je: het is aan jou, op je eigen schijven',
        'modes' => 'Wat eraan gedaan kan worden',
        'no_modes' => 'Deze machine bood niets aan om eraan te doen',
        'disturbs' => 'Stopt of verandert wat al draait',
        'disturbs_nothing' => 'Laat wat al draait zoals het is',
        'preselected' => 'Al gekozen aangeboden',
    ],
    ...
    'copy' => [
        ...
        'may_remove' => 'De stack bewaart een vast aantal kopieën, dus een nieuwe kan de oudste weghalen. Wat hij weghaalde, staat erbij als hij klaar is.',
        'taking' => 'Bezig met een kopie van :scope',
        'no_progress_while_running' => 'De stack zegt hoe groot een kopie werd als hij klaar is, en niets over hoe ver hij is terwijl hij loopt.',
        'no_outcome' => 'De stack weet niet meer wat er van de kopie van :scope geworden is',
        'no_outcome_action' => 'Misschien is hij gemaakt. De lijst met kopieën laat zien of hij er staat.',
        'a_rehearsal' => 'Een generale repetitie: er is niets geschreven',
        'copied' => 'Kopie gemaakt van :scope',
        'would_copy' => 'Dit zou een kopie maken van :scope',
        'removed' => '{0} Er is geen oudere kopie weggehaald|{1} Er is één oudere kopie weggehaald om ruimte te maken|[2,*] Er zijn :count oudere kopieën weggehaald om ruimte te maken',
        'would_remove' => '{0} Er zou geen oudere kopie weggehaald worden|{1} Er zou één oudere kopie weggehaald worden om ruimte te maken|[2,*] Er zouden :count oudere kopieën weggehaald worden om ruimte te maken',
        'kept_every_other' => 'Elke andere kopie is nog bewaard',
        'pace' => [
            'brisk' => 'Hij kwam op :moved :moved_unit, binnen de :budget :budget_unit die een kopie geacht wordt in een minuut te halen.',
            'slow' => 'Hij kwam op :moved :moved_unit, meer dan de :budget :budget_unit die een kopie geacht wordt in een minuut te halen, dus lang wachten kwam door wat er bewaard wordt en niet door een fout.',
            'would_be_brisk' => 'Hij zou op :moved :moved_unit komen, binnen de :budget :budget_unit die een kopie geacht wordt in een minuut te halen.',
            'would_be_slow' => 'Hij zou op :moved :moved_unit komen, meer dan de :budget :budget_unit die een kopie geacht wordt in een minuut te halen, dus lang wachten zou door wat er bewaard wordt komen en niet door een fout.',
        ],
        'holds_credentials' => 'Hij bevat de wachtwoorden en sleutels van de stack. Bewaar hem net zo zorgvuldig.',
        'holds_no_credentials' => 'Hij bevat geen wachtwoorden of sleutels van de stack.',
        'would_hold_credentials' => 'Hij zou de wachtwoorden en sleutels van de stack bevatten.',
        'would_hold_no_credentials' => 'Hij zou geen wachtwoorden of sleutels van de stack bevatten.',
        'see_the_copies' => 'Bekijk de kopieën',
        'scope' => [
            'whole_stack' => 'de hele stack',
            'service' => 'alleen :name',
            'existing' => 'de opstelling :name, die lemonfiber niet beheert',
        ],
    ],

    'put_back' => [
        'names_no_copy' => 'Dit noemt geen kopie om terug te zetten',
        'a_rehearsal' => 'Een generale repetitie: er is niets teruggezet',
        'would_put_back' => 'Deze kopie terugzetten zou :scope herstellen',
        'taken_by' => 'Gemaakt door lemonfiber :version op :at',
        'older' => 'Hij komt van een oudere hoofdversie van lemonfiber. Terugzetten mag, en kan daarna nog wat bijstellen vragen.',
        'would_move' => 'De gegevens zouden naar :now gaan, niet naar :was waar ze vandaan komen.',
        'would_go_where_it_was' => 'De gegevens zouden teruggaan naar waar ze vandaan komen.',
        'would_overwrite' => 'Dit zou overschrijven:',
        'holds_nothing' => 'De kopie noemt niets wat erin zit',
        'only_while_stopped' => 'De stack zet een kopie alleen terug als hij gestopt is, en zegt het als hij dat niet is.',
        'put_it_back' => 'Zet hem terug',
        'putting_back' => 'Bezig :copy terug te zetten',
        ...
        'no_outcome_action' => 'Misschien is hij teruggezet. De gezondheid van de machine is waar je kijkt.',
