...
return [
    'setting_count' => '{0} Deze stack heeft niets ingesteld|{1} Deze stack heeft één instelling|[2,*] Deze stack heeft :count instellingen',
    ...
    'came_from_bundled' => 'Standaardinstelling van de stack',
