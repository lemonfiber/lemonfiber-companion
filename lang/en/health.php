...
return [
    ...
    'walkthrough' => [
        ...
        'no_road' => 'The walk names no steps.',
        'walk_label' => 'What to fetch',
        'walk_placeholder' => 'A title',
        'blank_picks' => 'Leave it empty and the stack picks something likely to work.',
        'walk' => 'Start',
        ...
        'already_here_unnamed' => 'What was asked for was already here, so nothing was fetched again.',
        'walked' => 'Walked through “:item”',
        'proves' => 'What it set out to show: :proves',
        'stopped_at' => 'It stopped at :step',
        'try' => 'Try this: :remedy',
        'logs' => 'What the services were saying',
        'no_logs' => 'The services said nothing at the time.',
        'record' => 'The record of what it said, in order',
        'said_nothing' => 'It said nothing.',
        'in_background' => 'The download carries on in the background rather than being waited out.',
        'what_next' => 'What to do next',
        'where_to_watch' => 'Which app to watch on',
        'nothing_next' => 'It named nothing to do next.',
        'suggested' => 'Something likely to work',
        'walk_this' => 'Watch “:item” arrive',
        'nothing_suggested' => 'It suggested nothing.',
        'state' => [
            'offered' => 'Offered at the end of setup, and not answered yet.',
            'skipped' => 'Declined. It can be run whenever you like.',
            ...
            'complete' => 'It is in the library and ready to play.',
            'failed' => 'It stopped at a named step.',
            'abandoned' => 'Left part-way. Whatever was in flight carries on.',
        ],
        'shape' => [
            'pipeline' => 'The whole road: search, grab, download, import, and see it in the library.',
            'library-only' => 'For a stack that fetches nothing: media already on disk, checked for being visible to the media server.',
        ],
        'link' => [
            'hardlinked' => 'The library and the download share one file, so it costs no extra space.',
            'copied' => 'The file was copied, so it now takes up its space twice, and every import will do the same.',
        ],
        'next' => [
            'more-content' => 'Add more, now that you have seen how it works.',
            'household' => 'Let the rest of the household ask for things themselves.',
            'client-apps' => 'Watch it somewhere other than the machine it runs on.',
        ],
        'stopped' => [
            'no-indexers' => 'No indexer is set up, so there is nothing to search.',
            'indexers-failed' => 'The indexers, or the service holding them, would not answer, so the search never ran.',
            'nothing-matched' => 'The search ran and matched nothing. The indexers are working.',
            'none-met-the-preset' => 'Releases exist and none meets the quality preset. The stack is working; the preset and what is out there disagree.',
            'tunnel-down' => 'Torrents are in play and the tunnel is not verified up, so nothing was grabbed.',
            ...
            'no-media-server' => 'No media server runs in this form, so nothing can make it playable.',
            'not-visible' => 'It was imported and the media server was told, and the media server still cannot find it.',
        ],
    ],
